...
> 對象：維護／開發者。使用手冊在 `README.md`。本文件依**程式碼現況**整理，負責「模組之間」的關係；**每一條規則的完整理由、門檻與反例在 `docs/spec/`（13 章）**，本文是它的十分鐘版。
>
...
flowchart TD
    ...
    MODELS["models.py<br/>Line / Style / TextBlock<br/>（FONT_SIZES 在 style.py）"]
